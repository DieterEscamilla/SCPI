...
<link rel="stylesheet" href="{{asset('../resources/css/editar_formulario_styles3.css')}}">
...
@section('main')
    ...
    <div class="cont_tabla">
        <table class="tabla">
            ...
            <tbody class="cuerpo_tabla">
                @foreach($datos as $profesor)
                    <tr>
                        <td class="tdb nombre_completo">{{$profesor->nombre}} {{$profesor->primerApellido}} {{$profesor->segundoApellido}}</td>
                        <td class="tdb">{{$profesor->id}}</td>
                        ...
                        <td class="tdb elementos_ocultos_tabla edad_calculada">{{\Carbon\Carbon::parse($profesor->fechaNacimiento)->age;}}</td>
                        <td class="tdb elementos_ocultos_tabla">{{$profesor->fechaNacimiento}}</td>
        ...
        <div class="overlay_editar" id="overlay_editar_profesor">
            <div class="modal_editar_alumno">     
                <form class="form_editar" id="form_editar_alumno" action="{{route('profesores.update')}}" method="POST">
                        @csrf
                        @method('put')
                        <div class="cont_titulo_form_agreagr btn_cerrar_modal" id="btn_cerrar_modal">
                            <h3>Agregar nuevo profesor</h3>
                        ...
                        <div class="tira_provisional_inputs">
                            <div class="cont_lbl_input">
                                <label class="lbl_create" for="">Nombre:</label>
                                <input class="input_create input_editar_elemento" type="text" name="nombre" value="{{old('nombre')}}" required>
                                @error('nombre')
                                    <small class="leyenda_error_form">*{{$message}}</small>
                                @enderror
                            </div>
                            <div class="cont_lbl_input">
                                <label class="lbl_create" for="">Primer apellido:</label>
                                <input class="input_create input_editar_elemento" type="text" name="prim_apellido" value="{{old('prim_apellido')}}" required>
                                @error('prim_apellido')
                                    <small class="leyenda_error_form">*{{$message}}</small>
                                @enderror
                            </div>
                            <div class="cont_lbl_input">
                                <label class="lbl_create" for="">Segundo apellido:</label>
                                <input class="input_create input_editar_elemento" type="text" name="seg_apellido" value="{{old('seg_apellido')}}" required>
                                @error('seg_apellido')
                                    <small class="leyenda_error_form">*{{$message}}</small>
                                @enderror
                            </div>
                            <div class="cont_lbl_input">
                                <label class="lbl_create" for="">Número de tarjeta:</label>
                                <input class="input_create input_editar_elemento" type="text" name="id" value="{{old('id')}}" required>
                                @error('id')
                                    <small class="leyenda_error_form">*{{$message}}</small>
                                @enderror
                            </div>
                            <div class="cont_lbl_input">
                                <label class="lbl_create" for="">Grado escolar:</label>
                                <select class="input_create input_editar_elemento"  name="grado_escolar" value="{{old('grado_escolar')}}" required>
                                    <option value="">Seleccionar grado...</option>
                                    <option value="Licenciatura/ingeniería">Licenciatura/ingeniería</option>
                                    <option value="Maestría">Maestría</option>
                                    <option value="Doctorado">Doctorado</option>
                            ...
                            <div class="cont_lbl_input">
                                <label class="lbl_create" for="">Area adscripcion:</label>
                                {{-- En caso de que este campo deba ir en el form, preguntar todas las áreas de adscipción existentes --}}
                                <select class="input_create input_editar_elemento" name="area_adscripcion" value="{{old('area_adscripcion')}}" required>
                                    <option value="">Seleccionar área...</option>
                                    <option value="Departamento de ciencias basicas">Departamento de ciencias báscias</option>
                                    <option value="Departamento de gestión de recursos financieros">Departamento de gestión de recursos financieros</option>
                                    <option value="etc">Etc...</option>
                            ...
                            <div class="cont_lbl_input">
                                <label class="lbl_create" for="">Email:</label>
                                <input class="input_create input_editar_elemento" type="email" name="email" value="{{old('email')}}" required>
                                @error('email')
                                    <small class="leyenda_error_form">*{{$message}}</small>
                                @enderror
                            </div>
                            <div class="cont_lbl_input">
                                <label class="lbl_create" for="">Fecha de ingreso a la instutución:</label>
                                <input class="input_create input_editar_elemento" type="date" name="fecha_ingreso_institucion" value="{{old('fecha_ingreso_institucion')}}" required>
                                @error('fecha_ingreso_institucion')
                                    <small class="leyenda_error_form">*{{$message}}</small>
                                @enderror
                            </div>
                            ...
                            <div class="cont_lbl_input">
                                <label class="lbl_create" for="">Fecha de ingreso a la SEP:</label>
                                <input class="input_create input_editar_elemento" type="date" name="fecha_ingreso_sep" value="{{old('fecha_ingreso_sep')}}" required>
                                @error('fecha_ingreso_sep')
                                    <small class="leyenda_error_form">*{{$message}}</small>
                                @enderror
                            </div>        
                            <div class="cont_lbl_input">
                                <label class="lbl_create" for="">Fecha de nacimiento:</label>
                                <input class="input_create input_editar_elemento" type="date" name="fecha_nacimiento" value="{{old('fecha_nacimiento')}}" required>
                                @error('fecha_nacimiento')
                                    <small class="leyenda_error_form">*{{$message}}</small>
                                @enderror
                            </div>
                            <div class="cont_lbl_input">
                                <label class="lbl_create" for="">RFC:</label>
                                <input class="input_create input_editar_elemento" type="text" name="rfc" value="{{old('rfc')}}" required>
                                @error('rfc')
                                    <small class="leyenda_error_form">*{{$message}}</small>
                                @enderror
                            </div>
                        ...
                        <div class="cont_btns_formulario">
                            <input class="btn_aceptar estilos_compartidos_btn" type="submit" value="Agregar">
                            <button type="button" class="btn_cerrar_modal btn_cancelar estilos_compartidos_btn cerrar_modal_edit" value="Cancelar">Cancelar y volver al listado</button>
                        </div>
                </form>
            </div>
        </div>
...
@endsection
@section('scripts')
    <script src="{{asset('../resources/js/profesores4_scripts.js')}}"></script>
    <script src="{{asset('../resources/js/menuLateral_scripts2.js')}}"></script>
    <script src="{{asset('../resources/js/profesor_editar_formulario2.js')}}"></script>
@endsection